export default {
    settings: {
      ...
      conversationLog: {
        ...
        description: 'Asynchronously record user requests and AI responses for later review',
        enabled: 'Enable Conversation Logs',
        enabledHint: 'Record every model call; sync fallback is used by default when the queue is full',
        storeRequest: 'Store Request Body',
        storeRequestHint: 'Store the full user input and request payload',
        storeResponse: 'Store Response Body',
        storeResponseHint: 'Store the full assistant reply and response payload',
        workerCount: 'Writer Workers',
        queueSize: 'Queue Size',
        taskTimeoutSeconds: 'Write Timeout (seconds)',
        overflowPolicy: 'Queue Full Policy',
        overflowPolicySync: 'Sync Fallback',
        overflowPolicyHint: 'Sync fallback avoids losing records; under extreme load it may use request tail time',
        unlimitedBodyHint: 'Request and response bodies are stored in full without byte truncation',
        saved: 'Conversation log settings saved',
        saveFailed: 'Failed to save conversation log settings'
      },
      overloadCooldown: {
    ...
    conversationLogs: {
      ...
      liveStreamTitle: 'Live Conversation Stream',
      liveStreamHint: 'Only records created after opening this stream appear here.',
      demoLiveStreamHint: 'Local preview adds an in-progress conversation every 2.5 seconds; production uses SSE push.',
      startLiveStream: 'Open Live Stream',
      startLiveDemo: 'Start Live Demo',
      stopLiveStream: 'Stop Live Stream',
      inProgress: 'In progress',
      liveConnecting: 'Connecting…',
      liveConnected: 'Connected',
      liveDisconnected: 'Disconnected',
      liveEmpty: 'Waiting for a new conversation…',
      latestUserMessage: 'Latest user message',
      search: 'Search',
      mode: 'Mode',
      searchPlaceholder: 'Search request ID, response ID, model, user, API key, or account...',
      userSearchPlaceholder: 'Search request ID, response ID, or model...',
      modelPlaceholder: 'Model name',
      allPlatforms: 'All Platforms',
      allTypes: 'All Types',
      allStreams: 'All Modes',
      streamOnly: 'Streaming',
      nonStreamOnly: 'Non-streaming',
      time: 'Time',
      actor: 'User / Key',
      route: 'Route',
      model: 'Model',
      ...
      previewUnavailable: 'No displayable conversation text detected',
      previewOnDemand: 'Open the conversation to load its full content',
      previewMessages: '{count} messages',
      previewOperations: '{count} operations',
      demoSeedNotice: 'Development preview: records sampled from production and redacted before local display.',
      details: 'Conversation Details',
      requestInfo: 'Request information',
      requestInfoHint: 'Open to view user, key, route, usage, and identifiers',
      requestBody: 'User Request',
      responseBody: 'AI Response',
      noRequestBody: 'Request body not stored',
      noResponseBody: 'Response body not stored',
      noRecords: 'No conversation logs yet. New gateway requests will appear here after logging is enabled.',
      failedToLoad: 'Failed to load conversation logs',
      failedToLoadDetail: 'Failed to load conversation detail',
      copy: 'Copy',
      copied: 'Copied',
      ...
      timeline: {
        ...
        collapseTimeline: 'Collapse execution timeline',
        expandTimeline: 'Expand execution timeline',
        description: 'Review context, model replies, tool calls, and returned results in turn order.',
        searchPlaceholder: 'Search messages, calls, arguments, or results',
        jumpToRound: 'Jump to turn',
        searchResultCount: '{count} matches',
        noSearchResults: 'No matching conversation content',
        noSearchResultsHint: 'Try a different keyword, or clear the search to view the full conversation.',
        ...
        input: 'Arguments',
        output: 'Result',
        partialPayload: 'Partial payload captured',
