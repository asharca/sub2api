export default {
  ...
  conversationLogs: {
    ...
    searchPlaceholder: '搜索请求 ID、响应 ID 或模型...',
    userSearchPlaceholder: '搜索请求 ID、响应 ID 或模型...',
    ...
    previewUnavailable: '未识别到可展示的对话文本',
    previewOnDemand: '点击“查看对话”加载完整内容',
    previewMessages: '{count} 条消息',
    previewOperations: '{count} 次操作',
    demoSeedNotice: '开发预览：展示从生产记录采样并在本地显示前完成脱敏的数据。',
    details: '对话详情',
    requestBody: '用户请求',
    responseBody: 'AI 响应',
    noRequestBody: '未保存请求体',
    noResponseBody: '未保存响应体',
    noRecords: '暂无对话记录。开启记录后，新的网关请求会出现在这里。',
    failedToLoad: '加载对话记录失败',
    failedToLoadDetail: '加载对话详情失败',
    copy: '复制',
    copied: '已复制',
    requestId: '请求 ID',
    responseId: '响应 ID',
    ...
    timeline: {
      ...
      input: '调用参数',
      output: '执行结果',
      partialPayload: '已截断的记录',
      showFullMessage: '查看完整消息',
