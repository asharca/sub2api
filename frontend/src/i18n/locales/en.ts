  ...
  admin: {
    ...
    settings: {
      ...
      conversationLog: {
        ...
        enabledHint: 'Record each model call without blocking normal chat responses',
        storeRequest: 'Store Request Body',
        storeRequestHint: 'Keep user input and request payload snippets',
        storeResponse: 'Store Response Body',
        storeResponseHint: 'Keep assistant replies and response payload snippets',
        ...
        overflowPolicyDrop: 'Drop New Tasks',
        overflowPolicyHint: 'Sync fallback avoids losing records, but can use request time under extreme load',
        maxRequestBytes: 'Max Request Bytes',
        maxResponseBytes: 'Max Response Bytes',
        bytesHint: '0 means unlimited bytes',
